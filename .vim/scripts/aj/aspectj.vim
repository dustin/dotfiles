...
" Maintainer:	Thomas-Ivo Heinen <cochi@t-online.de>
" URL:		http://cochi.bei.t-online.de/files/aspectj.vim
" Last Change:	2001 May 11
" Based on the Java syntax file by Claudio Fleiner
...
" keyword definitions (AspectJ)
syn keyword javaAspect		pointcut aspect after before of
"" objects
syn keyword javaAspect		instanceof hasaspect
""lexical extents
syn keyword javaAspect		within withinall withincode
""control flow
syn keyword javaAspect		cflow cflowbelow
""methods & constructors
syn keyword javaAspect		calls receptions executions callsto
""initializer
syn keyword javaAspect		initializations staticinitializations
""exception handlers
syn keyword javaAspect		handlers
""fields
syn keyword javaAspect		gets sets
""advices
syn keyword javaAspect		before after returning returns around

" keyword definitions (Java)
...
if !exists("java_ignore_javadoc")
  ...
  syn match javaDocTags contained "@\(version\|author\|return\|deprecated\|since\|brother\|sister\|todo\)\>"
  syntax case match
endif
